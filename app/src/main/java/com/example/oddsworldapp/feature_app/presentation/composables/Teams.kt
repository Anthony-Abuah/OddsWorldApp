...
import com.example.oddsworldapp.feature_app.presentation.ui.theme.*
    ...
    Box(
        ...
        Column(
            ...
            Box(modifier = Modifier.weight(2f)){
                BasicText(text = date, fontSize = 14.sp, textColor = OddsCardContentColor)
            }

            Box(modifier = Modifier.weight(2.5f)){
                TitleText(title = time, fontSize = 14.sp, textColor = OddsCardContentColor)
            }
